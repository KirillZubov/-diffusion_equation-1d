...
quasirandom_strategy = QuasiRandomTraining(100; #points
                                                     sampling_alg = UniformSample(),
                                                     minibatch = 100)
quadrature_strategy = QuadratureTraining(quadrature_alg = CubatureJLp(),reltol=1e-5,abstol=1e-5,maxiters=50)
